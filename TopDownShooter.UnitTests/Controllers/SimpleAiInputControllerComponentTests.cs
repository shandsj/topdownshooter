...
namespace TopDownShooter.UnitTests.Controllers
{
    ...
    /// <summary>
    /// Class for testing the <see cref="TopDownShooter.Controllers.SimpleAiInputControllerComponent"/>
    /// </summary>
    [TestClass]
    public class SimpleAiInputControllerComponentTests
    {
        ...
        /// <summary>
        /// The <see cref="TopDownShooter.Controllers.SimpleAiInputControllerComponent"/> should not utilize the Draw method
