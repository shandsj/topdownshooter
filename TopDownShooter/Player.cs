...
namespace TopDownShooter
{
    ...
    public class Player : GameObject, IPlayer
    {
        ...
        private IDashComponent dashComponent;
            ...
            : base(id, components)
        {
            ...
            this.dashComponent = this.Components.OfType<IDashComponent>().FirstOrDefault();
            ...
            this.particleGeneratorComponent = this.Components.OfType<IParticleGeneratorComponent>().FirstOrDefault();
