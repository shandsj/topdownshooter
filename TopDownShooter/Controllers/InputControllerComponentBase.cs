...
namespace TopDownShooter.Controllers
{
    ...
    public abstract class InputControllerComponentBase : IInputController, IComponent, IDisposable
    {
        ...
        public virtual void Update(IGameObject gameObject, GameTime gameTime)
        {
            ...
            {
                gameObject.BroadcastMessage(new Message((int)Messages.MessageType.Movement, gameObject.Velocity), gameTime);
            }
            ...
            if (this.Dash())
            {
                gameObject.BroadcastMessage(new Message((int)Messages.MessageType.Dash), gameTime);
            }
        }
